@props(['title' => __('Confirmer le mot de passe'), 'content' => __('Pour des raisons de sécurité, veuillez confirmer votre mot de passe pour continuer.'), 'button' => __('Confirmer')])
