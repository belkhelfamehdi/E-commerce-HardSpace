    ...
    <div class="flex flex-col mt-8">
        ...
        @endif
            <div class="flex justify-between mb-3">
                <a href="{{route('supplier.products.create')}}" class="bg-transparent text-sm hover:bg-pcolor py-3 text-pcolor font-semibold hover:text-white px-6 border border-pcolor hover:border-transparent rounded">
                    Ajouter un produit
                </a>
