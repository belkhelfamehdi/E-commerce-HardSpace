    ...
    <header class="text-white relative h-auto xl:h-screen bg-no-repeat bg-cover max-w-full ease-in duration-200" id="background-image">
        ...
        <div class="container mx-auto px-4 py-2 pt-4 flex items-center justify-between flex-wrap md:px-5">
            <a href="{{route('index')}}" class="flex items-center">
                    <img id="logo" class="max-md:relative z-50 object-contain h-12 w-12" src="{{ url('frontend/assets/images/logo/Logo_white.png') }}" data-src="{{url('frontend/assets/images/logo/Logo_black.png')}}" alt="">
                </a>
            ...
            <div  class="max-md:hidden max-md:text-black max-md:dark:text-white text-sm bg-white dark:bg-dcolor md:bg-transparent max-md:fixed max-md:h-screen z-40 top-0 left-0  md:relative mx-auto w-full text-center md:flex md:order-2 md:flex-grow md:w-auto" id="navigation">
                ...
                <div class="btn-i max-md:relative max-md:top-20 pt-5 justify-center md:pt-0 mt-2 lg:pr-4 flex w-auto " x-data = "{search : false}">
                  ...
                  <div class="def-i">
                    <span class="search" @click="search = !search"><i class="fa-solid fa-magnifying-glass mr-4 fa-lg md:py-2 md:px-3 cursor-pointer transition-all ease-in-out duration-100 hover:scale-125 hover:text-pcolor"></i></span>
                    <span class="account"><i class="fa-solid fa-user fa-lg mx-4 md:py-2 md:px-3 cursor-pointer transition-all ease-in-out duration-100 hover:scale-125 hover:text-pcolor"></i></span>
                    <span class="cart"><i class="fa-solid fa-cart-shopping ml-4 fa-lg md:py-2 md:px-3 cursor-pointer transition-all ease-in-out duration-100 hover:scale-125 hover:text-pcolor"></i></span>
                  </div>
                </div>
            </div>
            </div>
                  ...
                  >
                    ...
                    <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end ">
                      <form class="w-full">
                        ...
                        <div
                          class="border border-white p-2 focus-within:ring sm:flex sm:items-center sm:gap-4"
                        >
                          <input
                            type="email"
                            id="UserEmail"
                          ...
                          <button
                            class="mt-1 w-full bg-pcolor px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-colors duration-200 hover:bg-white hover:text-black sm:mt-0 sm:w-auto sm:flex-shrink-0"
                          >
                            S'abonner
                          </button>
                        </div>
              ...
              <ul class="flex justify-center gap-6 mt-8 ">
                <li>
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    class="text-gray-400 transition hover:text-pcolor dark:text-gray-200"
                  >
                ...
                <nav aria-label="Footer Navigation - Services" class="mt-6">
                  <ul class="space-y-4 text-sm">
                    <li>
                      <a
                        href="#"
                        class="text-white transition hover:text-pcolor dark:text-gray-200"
                      >
                      Lorem ipsum
                      </a>
                    </li>
