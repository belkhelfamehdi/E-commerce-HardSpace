          ...
          <div class="sm:col-span-4">
            ...
            <div class="mt-2">
              <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-pcolor sm:max-w-md">
                <input type="text" name="company_name" id="company_name" autocomplete="organization" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Nom de l'entreprise">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <p class="mt-1 mb-6 text-sm leading-6 text-gray-600">Veuillez vous assurez de vos informations avant valider la demande.</p>
          ...
          <div class="sm:col-span-4 py-2">
            ...
            <div class="mt-2">
              <input id="company_number" name="company_number" type="tel" autocomplete="tel-national" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pcolor sm:text-sm sm:leading-6">
            </div>
          </div>
