      ...
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <div class="pb-6">
            <div class="col-span-full">
              ...
              <div class="mt-2">
                <textarea id="message" name="message" rows="8" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pcolor sm:text-sm sm:leading-6" disabled>{{$application->message}}</textarea>
              </div>
            </div>
          </div>
